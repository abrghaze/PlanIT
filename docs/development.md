...
the worktree unchanged. Schema version 5 stores the owner-scoped account and
...
responses, recurring plans, goals, and a transactional outbox. Debt, repayment,
share, refund, transfer, reconciliation, and reallocation commands use that
durable outbox and refresh canonical server projections after acknowledgment.
