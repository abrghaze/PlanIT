...
**Delivery status:** Milestones 0 through 8 are complete in release `0.9.0`.
...
The planned delivery sequence is complete. Planning occurrences and manual goal
allocations remain authoritative metadata; analytics and anomaly-style insights
remain disposable, explainable read models over canonical financial facts. Paid
OCR or banking providers are intentionally not enabled by default.
