...
_FINANCIAL_INTEGRITY_CONSTRAINTS = {
    "debt_origin_coherent",
    "debt_origin_link_required",
    "debt_overpayment",
    "debt_payment_coherent",
    "debt_payment_link_required",
    "debt_status_coherent",
    ...
    "recoverable_expense_required",
    "refund_exceeds_remaining",
    "refund_parent_required",
    "refund_transaction_coherent",
    "same_currency_transfer_coherent",
    "shared_expense_cap",
    "shared_expense_debt_coherent",
